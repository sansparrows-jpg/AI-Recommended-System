...
with st.container(border=True):
    ...
    st.caption(
        "Final recommendation generated by comparing and ranking Content-Based, Collaborative, and Hybrid outputs."
    )
    show_table(
        final_results,
        [
...
with col3:
    with st.container(border=True):
        st.subheader("Hybrid")
        st.caption("Recommendations generated by combining Content-Based and Collaborative Filtering.")
